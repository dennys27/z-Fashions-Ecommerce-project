...
paypal.configure({
  ...
  // setWalletCredit: (userId, orderId, amount, credit, debit) => {
  ...
  // },
    (module.exports = {
        ...
        return new Promise(async (resolve, reject) => {
          ...
          if (email) {
            ...
            if (userData.Refferal) {
              userData.Refferal = userData.Refferal.toString();
              let user = await db
                .get()
                .collection(collection.USER_COLLECTION)
              ...
              .then((data) => {
                ...
                new Promise(async (resolve, reject) => {
                  ...
                  let usertwo = await db
                    .get()
                    .collection(collection.WALLET_COLLECTION)
                    .find({ user: objectId(data.insertedId) })
                    .toArray();
                  let walletHistory = {
      ...
      updateUser: (userId, userDetails) => {
        return new Promise(async (resolve, reject) => {
          userDetails.newpassword = await bcrypt.hash(
      ...
      generatePayPal: (orderId, totalPrice) => {
        return new Promise((resolve, reject) => {
          const create_payment_json = {
            ...
            redirect_urls: {
              return_url: "https://www.z-fashions.gq/success",
              cancel_url: "https://www.z-fashions.gq/cancel",
            },
            transactions: [
              {
                item_list: {
